    ...
    return (
        <>
            ...
            <Examples
                ...
                example1BackgroundPhoto={urlFor(example1BackgroundPhoto)}
                example1ProductPhoto={urlFor(example1ProductPhoto)}
                ...
                example2BackgroundPhoto={urlFor(example2BackgroundPhoto)}
                example2ProductPhoto={urlFor(example2ProductPhoto)}
                ...
                example3BackgroundPhoto={urlFor(example3BackgroundPhoto)}
                example3ProductPhoto={urlFor(example3ProductPhoto)}
                ...
                example4BackgroundPhoto={urlFor(example4BackgroundPhoto)}
                example4ProductPhoto={urlFor(example4ProductPhoto)}
